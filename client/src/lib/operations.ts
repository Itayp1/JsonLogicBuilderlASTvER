import { OperationCategory, Operation } from '@/components/JSONLogicBuilder/types';

// Logic operations
const logicOperations: Operation[] = [
...
const comparisonOperations: Operation[] = [
...
const dataOperations: Operation[] = [
...
// Array operations
const arrayOperations: Operation[] = [
